...
namespace Relay.Infrastructure.Migrations
{
    ...
    [Migration("20260801221349_AddRetryAndReplay")]
    partial class AddRetryAndReplay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Relay.Core.Delivery", b =>
                {
                    ...
                    b.Property<Guid?>("ReplayOfDeliveryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReplayOfDeliveryId", "ReplayIdempotencyKey")
                        .IsUnique()
